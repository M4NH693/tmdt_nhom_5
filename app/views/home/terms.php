    ...
    <div class="terms-card" style="background: white; padding: 40px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); max-width: 900px; margin: 0 auto; line-height: 1.6; color: #333;">
        ...
        <section id="gioi-thieu-chung" style="margin-bottom: 25px;">
            ...
            <ul style="padding-left: 20px;">
                ...
                <li style="margin-bottom: 10px;">Chúng tôi có quyền sửa đổi, bổ sung Điều khoản này bất kỳ lúc nào. Phiên bản cập nhật sẽ được đăng tải trên website và có hiệu lực ngay khi đăng. Việc bạn tiếp tục sử dụng website sau khi thay đổi nghĩa là bạn chấp nhận phiên bản mới.</li>
            </ul>
        </section>
        ...
        <section id="tai-khoan" style="margin-bottom: 25px;">
            ...
            <ul style="padding-left: 20px;">
                ...
                <li style="margin-bottom: 10px;">Bạn chịu trách nhiệm bảo mật tài khoản và mật khẩu. Mọi hoạt động dưới tài khoản của bạn đều được coi là do bạn thực hiện.</li>
                <li style="margin-bottom: 10px;">Chúng tôi có quyền từ chối, khóa hoặc xóa tài khoản nếu phát hiện thông tin sai lệch, vi phạm pháp luật hoặc lạm dụng dịch vụ.</li>
            </ul>
        </section>
        ...
        <section id="huong-dan-mua-hang" style="margin-bottom: 25px;">
            ...
            <ul style="padding-left: 20px;">
                ...
                <li style="margin-bottom: 10px;">Chúng tôi có quyền từ chối đơn hàng trong các trường hợp: hết hàng, giá sai, nghi ngờ gian lận, hoặc lý do chính đáng khác. Nếu từ chối, chúng tôi sẽ thông báo và hoàn tiền (nếu đã thanh toán).</li>
            </ul>
        </section>
        ...
        <section id="phuong-thuc-thanh-toan" style="margin-bottom: 25px;">
            ...
            <ul style="padding-left: 20px;">
                ...
                <li style="margin-bottom: 10px;">Phương thức thanh toán: Thanh toán khi nhận hàng (COD), chuyển khoản ngân hàng, ví điện tử, thẻ tín dụng (nếu tích hợp).</li>
            </ul>
        </section>
        ...
        <section id="van-chuyen" style="margin-bottom: 25px;">
            ...
            <ul style="padding-left: 20px;">
                ...
                <li style="margin-bottom: 10px;">Bạn có trách nhiệm kiểm tra hàng hóa ngay khi nhận. Nếu phát hiện sai sót (sai sách, hỏng hóc, thiếu số lượng), vui lòng từ chối nhận hoặc chụp ảnh/video làm bằng chứng và liên hệ ngay với chúng tôi trong vòng 24 giờ.</li>
                <li style="margin-bottom: 10px;">Rủi ro mất mát/hư hỏng trong quá trình vận chuyển do đơn vị vận chuyển chịu trách nhiệm theo thỏa thuận.</li>
            </ul>
        </section>
            ...
            <ul style="padding-left: 20px;">
                <li style="margin-bottom: 10px;">Bạn có quyền đổi trả trong vòng 30 ngày kể từ ngày nhận hàng với điều kiện:
                    <ul style="padding-left: 20px; list-style-type: circle; margin-top: 5px;">
                        ...
                        <li>Không áp dụng với sách đã mở seal</li>
                    </ul>
                </li>
                <li style="margin-bottom: 10px;">Lý do được chấp nhận: Sai sản phẩm, lỗi kỹ thuật từ nhà xuất bản, hư hỏng trong vận chuyển.</li>
                <li style="margin-bottom: 10px;">Chúng tôi không hoàn tiền nếu bạn đổi ý (không thích, mua nhầm...).</li>
            </ul>
        </section>
        ...
        <section id="quyen-khach-hang" style="margin-bottom: 25px;">
            ...
            <ul style="padding-left: 20px;">
                ...
                <li style="margin-bottom: 10px;">Không sử dụng website để mục đích bất hợp pháp, spam, hack, sao chép nội dung...</li>
                <li style="margin-bottom: 10px;">Thanh toán đầy đủ và đúng hạn.</li>
                <li style="margin-bottom: 10px;">Tuân thủ các quy định về bản quyền sách (không sao chép, trái phép).</li>
            </ul>
        </section>
        ...
        <section id="quyen-cua-hang" style="margin-bottom: 25px;">
            ...
            <ul style="padding-left: 20px;">
                ...
                <li style="margin-bottom: 10px;">Bảo vệ thông tin cá nhân của bạn theo Chính sách bảo mật (riêng biệt).</li>
                <li style="margin-bottom: 10px;">Có quyền hủy đơn, khóa tài khoản nếu phát hiện vi phạm.</li>
                <li style="margin-bottom: 10px;">Không chịu trách nhiệm với các sự cố ngoài tầm kiểm soát (thiên tai, dịch bệnh, gián đoạn mạng...)</li>
            </ul>
        </section>
        ...
        <section id="ban-quyen" style="margin-bottom: 25px;">
            ...
            <ul style="padding-left: 20px;">
                ...
                <li style="margin-bottom: 10px;">Bạn không được sao chép, chỉnh sửa, phân phối mà không có sự đồng ý bằng văn bản.</li>
            </ul>
        </section>
        ...
        <section id="dieu-khoan-chung" style="margin-bottom: 25px;">
            ...
            <ul style="padding-left: 20px;">
                ...
                <li style="margin-bottom: 10px;">Điều khoản này được lập bằng tiếng Việt và là phiên bản chính thức. Bản dịch sang ngôn ngữ khác chỉ mang tính tham khảo.</li>
                <li style="margin-bottom: 10px;">Chúng tôi không chịu trách nhiệm pháp lý đối với bất kỳ thiệt hại gián tiếp nào phát sinh từ việc sử dụng website (trừ trường hợp pháp luật quy định khác).</li>
            </ul>
        </section>
    </div>
</div>
